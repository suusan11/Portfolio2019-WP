...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-140687487-2"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-140687487-2');
    </script>
...
<header data-scroll-header class="header">
    ...
    <div class="header__flex">
        <div class="name__flex">
            <a class="header__icon" href="<?php get_template_directory_uri()?>/index.php"><img src="<?php echo get_template_directory_uri()?>/dist/images/profile.png" alt="profile image"></a>
            <h3>MIE SUZUKI</h3>
        </div>
        <?php
        wp_nav_menu( array(
        ...
        <ul class="header__flex--right">
            <li><a data-scroll href="<?php get_template_directory_uri()?>/index.php#works">WORKS</a></li>
            <li><a data-scroll href="<?php get_template_directory_uri()?>/index.php#values">VALUES</a></li>
            <li><a data-scroll href="<?php get_template_directory_uri()?>/index.php#contact">CONTACT</a></li>
        </ul>
        <div class="global__menu">
            ...
            <div id="js-global-menu" class="click__open">
                ...
                ?>
                <ul>
                    <li class="js-link-menu"><a href="<?php get_template_directory_uri()?>/index.php">HOME</a></li>
                    <li class="js-link-menu"><a href="<?php get_template_directory_uri()?>/index.php#works">WORKS</a></li>
                    <li class="js-link-menu"><a href="<?php get_template_directory_uri()?>/index.php#values">VALUES</a></li>
                    <li class="js-link-menu"><a href="<?php get_template_directory_uri()?>/index.php#contact">CONTACT</a></li>
                </ul>
                <div class="sns__flex">
