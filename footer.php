...
<footer id="contact">
    <div class="contact">
        <p>Drop me a line. I'll get back to you soon.</p>
        <h2><a href="mailto:miesuzuki107@gmail.com">miesuzuki107@gmail.com</a></h2>
    </div>
    <div class="footer__flex">
        <a href="https://www.linkedin.com/in/mie-suzuki-079644161/" target="_blank"><svg class="icon icon-linkedin2">
        ...
        <a href="https://github.com/suusan11" target="_blank"><svg class="icon icon-github">
        ...
        <a href="https://dribbble.com/suusan1228" target="_blank"><svg class="icon icon-dribbble">
        ...
        <a href="https://www.instagram.com/miiiiiiiiiiie.55/" target="_blank"><svg class="icon icon-instagram">
