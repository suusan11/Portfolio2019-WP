...
<div class="animsition">
    ...
    <div class="work__intro--flex">
        <section id="js-breakPoint" class="work__intro--black container ui">
            <h2>DailyUI</h2>
            <p>Challenging “Daily UI”. During designing 100 of theme, I have improved my skill of design and using those
                tool.</p>
            ...
            <a class="hover__link" href="https://dribbble.com/suusan1228" target="_blank">See all works</a>
        </section>

        <section class="work__intro container ui">
            <div class="work__intro-top">
                <img src="<?php echo get_template_directory_uri()?>/dist/images/ui/thumbnail.png"
                    alt="ui design thumbnail">
            </div>
        </section>
    </div>
    ...
    <section class="work__ui container">
        <div class="work__description">
            ...
            <img src="<?php echo get_template_directory_uri()?>/dist/images/ui/work-img1.png"
                alt="work image ui">
        </div>
        <div class="work__color">
            ...
            <div class="work__color--item">
                ...
                <div class="work__color--item--flex-top ui-color">
                    ...
                    <img src="<?php echo get_template_directory_uri()?>/dist/images/ui/component1-1.png"
                        alt="component success ui">
                </div>
            </div>
            <div class="work__color--item">
                <h4>Error</h4>
                <div class="work__color--item--flex-bottom ui-color">
                    ...
                    <img src="<?php echo get_template_directory_uri()?>/dist/images/ui/component1-2.png"
                        alt="component error ui">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="work__ui container">
        <div class="work__description">
            ...
            <img class="work__img--small"
                src="<?php echo get_template_directory_uri()?>/dist/images/ui/work-img2.png"
                alt="work image ui">
        </div>
        <div class="work__color">
            <h1 class="section__title work__h1">Colors</h1>
    ...
    <section class="work__link">
        <a class="common__button button__work--bottom" href="https://dribbble.com/suusan1228" target="_blank">See all
            works</a>
